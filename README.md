...
_A modern, full-stack web application for managing barbershops, appointments, and client relationships with real-time appointment management and OAuth authentication._
...
- **[Laravel Socialite](https://laravel.com/docs/socialite)** - OAuth authentication (Google, GitHub)
- **[Intervention Image](https://image.intervention.io)** - Image processing and optimization (WebP conversion, resizing)
